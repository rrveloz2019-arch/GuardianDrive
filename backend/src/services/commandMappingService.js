...
const DEFAULT_MAPPINGS = [
  ...
  { id: 'default-calls-resolve', triggerPhrase: 'call', capabilityId: 'calls', actionId: 'call' },
  { id: 'default-texts-compose', triggerPhrase: 'send a text to', capabilityId: 'texts', actionId: 'send' },
